...
![Sketch of data visualization of Poisson probability](ch13-viz-prob.png)
...
![Sketch of data visualization with cumulative probability](ch13-viz-cum-prob.png)
...
* Create a similar sequence of data visualizations for the
  Binomial regression [@Binomial_regression]
  model.

Next, [Chapter 14](/ch14) explains how to use the
named `clickSelects` and `showSelected` to visualize the `PeakSegJoint`
segmentation model with data-driven selector variables.