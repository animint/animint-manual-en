...
![legend clickSelects](../Ch04/Ch04-legend-clickSelects.png)
...
![World Bank viz text](../Ch04/Ch04-viz-text-single.png)
...
![World Bank viz text](../Ch04/Ch04-viz-text.png)
...
![World Bank time series](../Ch04/Ch04-ggplot-time-series-plot.png)
...
**Animation exercise:** make the data viz animated by specifying the
  `time` option,
  [as explained in Chapter 3](../Ch03/Ch03-showSelected.html#animation-time).
...
![World Bank scatter facet](../Ch04/Ch04-ggplot-scatterFacet.png)
...
state is displayed](../Ch06/Ch06-other.html#display-selection-state).
...
Next, [Chapter 5](../Ch05/Ch05-sharing.html) explains several different
