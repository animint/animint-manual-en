...
## The strftime/strptime code below only works in locales with English
## days of the week.
Sys.setlocale(locale="en_US.UTF8")#for Sat, Sun.
...
table(montreal.bikes$counter.counts$location)
library(data.table)
...
Next, [Chapter 10](../Ch10/Ch10-nearest-neighbors.html) explains how to visualize the
