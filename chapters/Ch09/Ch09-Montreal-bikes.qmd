...
deaths_severe_slight <- function(deaths, severe, slight)paste(
  fcase(
    deaths==0, "",
    deaths==1, "1 death,",
    default=paste(deaths, "deaths,")),
  fcase(
    severe==0, "",
    severe==1, "1 person severely injured,",
    default=paste(severe, "people severely injured,")),
...
Next, [Chapter 10](../Ch10/Ch10-nearest-neighbors.html) explains how to visualize the K-Nearest-Neighbors machine learning model.
