...
The output above shows one row per month with both count and accident data.
...
We use the code below to establish correspondence between the names in the two tables.
