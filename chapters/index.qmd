...
This chapter gives an overview of data analysis and visualization.
...
Starting with [chapter 2](Ch02/Ch02-ggplot2.html), we will show how plot
...
[Chapter 3](Ch03/Ch03-showSelected.html) introduces showSelected, one of
...
[Chapter 4](Ch04/Ch04-clickSelects.html) introduces clickSelects, the other
...
[Chapter 5](Ch05/Ch05-sharing.html) explains several different ways to
share your interactive data visualizations on the web.

[Chapter 6](Ch06/Ch06-other.html) covers some other features of `animint2`,
including how to specify hyperlinks, tooltips, data-driven selector
variable names.

[Chapter 7](Ch07/Ch07-limitations.html) covers the limitations of the
...
[Chapter 8](Ch08/Ch08-WorldBank-facets.html) explains how to create a multi-panel interactive World Bank
data visualization.

[Chapter 9](Ch09/Ch09-Montreal-bikes.html) shows a visualization of data from cyclists in Montreal.

[Chapter 10](Ch10/Ch10-nearest-neighbors.html) explains how to create an
...
[Chapter 11](Ch11/Ch11-lasso.html) shows a data visualization that explains the Lasso, a
machine learning model for regularized regression.

[Chapter 12](Ch12/Ch12-SVM.html) shows a data visualization that explains support vector
machines (SVM), a machine learning model for binary classification.

[Chapter 13](Ch13/Ch13-poisson-regression.html) explains how to create an
interactive visualization that explains the Poisson regression model.

[Chapter 14](Ch14/Ch14-PeakSegJoint.html) shows an example of how to create
data-driven selectors using named clickSelects/showSelects in an
interactive visualization of a peak detection model.

[Chapter 15](Ch15/Ch15-Newton.html) explains how to create an interactive
visualization of the Newton root-finding algorithm.

[Chapter 16](Ch16/Ch16-change-point.html) explains how to create an interactive
visualization of an optimal changepoint detection model.

[Chapter 17](Ch17/Ch17-k-means-clustering.html) explains how to create an
interactive visualization of the k-means clustering algorithm.

[Chapter 18](Ch18/Ch18-neural-networks.html) explains how to create an
interactive visualization of the gradient descent algorithm for
learning neural network weight matrices.

### Appendices {#appendices}

[Useful idioms](Ch99/Ch99-appendix.html) contains detailed explanations of several R code idioms that are used throughout this manual.
...
Next, [Chapter 2](Ch02/Ch02-ggplot2.html) explains how the grammar of graphics can be used to create data visualizations.
