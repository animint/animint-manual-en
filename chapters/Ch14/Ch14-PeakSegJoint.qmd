...
[named clickSelects/showSelected variables](../Ch06/Ch06-other.html#data-driven-selectors) for
...
if(!file.exists("PSJ.RData")){
  ...
  download.file(u, "PSJ.RData", mode="wb")
}
load("PSJ.RData")
```
...
[Ch14-for/index.html](../Ch14/Ch14-for/index.html). In the next section we
...
[Ch14-named/index.html](../Ch14/Ch14-named/index.html). Note that it
...
Next, [Chapter 15](../Ch15/Ch15-Newton.html) explains how to visualize
