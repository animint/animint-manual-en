...
**Exercise:** Re-make this data visualization using `aes(tooltip)`, which is a new feature in `animint2` (not present in `ggplot2`), and is discussed in [Chapter 5](/ch06#new-aesthetics).
