...
review your Pull Request [@Pull_Request].
...
support for this, see the update axes test for details [@update-axes-multiple-ss].
...
issue explaining how to implement it [@issue_explaining_how_to_implement_it].
...
an issue [@an_issue], and would be
...
Also note in these examples that the text size is not consistent between static and interactive rendering, which is an issue [@is_an_issue]
...
all of the theme options [@all_of_the_theme_options],
