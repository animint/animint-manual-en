...
set.seed(1)
(sim_dt <- CJ(
  true_offset=round(seq(-3, 3, by=offset_by), ceiling(-log10(offset_by))),
...
To begin, define the helper function below, which is used to add `round_*` and `rel_*` columns which we will use to define heat map tiles.
