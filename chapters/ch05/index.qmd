...
* Begin by writing some visualization code in `figure-name.R` in a GitHub repository, where `name` is an informative name for your data visualization. For example, the [tdhock/cs499-spring2020](https://github.com/tdhock/cs499-spring2020) GitHub repository contains visualization code in [figure-quadratic-interactive.R](https://github.com/tdhock/cs499-spring2020/blob/master/2020-02-03-capacity/figure-quadratic-interactive.R).
...
* If you want to make larger modifications, it is recommended to copy the R code to a new file, for example [figure-several-interactive.R](https://github.com/tdhock/cs499-spring2020/blob/master/2020-02-03-capacity/figure-several-interactive.R) for a new visualization with an additional selector for `pattern`.
...
* The R code file has a link to the repo that deployed the data visualization, for example:
  * the R code in [figure-quadratic-interactive.R](https://github.com/tdhock/cs499-spring2020/blob/master/2020-02-03-capacity/figure-quadratic-interactive.R)
...
* The data visualization deployment repo has a [README.md](https://github.com/tdhock/2020-02-03-capacity-polynomial-degree/blob/gh-pages/README.md) which has a link to the data visualization, <https://tdhock.github.io/2020-02-03-capacity-polynomial-degree/>.
