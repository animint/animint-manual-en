...
my useR 2017 tutorial [@my_useR_2017_tutorial].
...
* Re-design the previous animint so that instead of using a third
  plot, add a facet to the max margin regression plot such
...
* Make another data viz by starting with the facetted `gg.signals`
  ...
  signal -- you can use named `clickSelects` and `showSelected` as explained in
  [Chapter 14](/ch14)). The result should look
  something
  like this [@mmir_chipseq].

Next, [Chapter 17](/ch17) explains how to
