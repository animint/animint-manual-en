...
![Sketch of static data visualization of K-Nearest Neighbors classification](Ch10-viz-static.png)
...
![Sketch of interactive data visualization of K-Nearest Neighbors](Ch10-viz-interactive.png)
...
In the previous scatterplot, the data for several geoms were broken into different files, one for each number of neighbors.

```{r}
Sys.glob("Ch10vizfolds/*common.tsv")
```

the plotted points all occur at the same x/y positions, across `showSelected` subsets.
