...
![Static KNN viz](../Ch10/Ch10-viz-static.png)
...
[summarize data table idiom](../Ch99/Ch99-appendix.html#summarize-data-table)
...
![Interactive KNN viz](../Ch10/Ch10-viz-interactive.png)
...
* Make it so that text error rates in the bottom left of the second
  ...
  explained in [Chapter 14](../Ch14/Ch14-PeakSegJoint.html)) or two
...
Next, [Chapter 11](../Ch11/Ch11-lasso.html) explains how to visualize the
