...
nn_learner$param_set$values$k <- paradox::to_tune(1, 20)
...
score_dt <- bench.result$score(mlr3::msrs(c('classif.auc','classif.ce')))[, let(
...
animint(
  ...
  testAUC=ggplot()+
    ...
    scale_x_continuous(
      limits=c(0.5,1)),
  roc=ggplot()+
    ## TODO add pred point for threshold=0.5
    theme_bw()+
    geom_path(aes(
